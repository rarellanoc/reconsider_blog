...
I’ve seen many interviews to Mauricio and Sofia, but no student before had the nerve to ask about computation, especially after they visited the Illinois Institute, last year. Kind of the place to relate with technology and architecture. But the student asks we all wanted to know: “What are your thoughts about computation in architecture?”
...
Pezo is an architecture office located in Concepción. It’s a couple, plus some interns and external contractors. They do both art and architecture. In the art camp, they tend to do artisan series, which requires a concern for multiplying geometry. They can get away without much concern for tools, as shown in Chicago once with the inverted T, the 129 paintings variations. 

I bet on that occasion they used a generator, but probably done by an external or intern that knew a bit more about how to do the array. 
...
I resume the video of the lecture at the GSD.  

“Good question,”, he starts. 
“We don’t have any real attachment to any computational tool, we barely use the cellphone.” He points out half-joking in his calm style. 
...
It’s like. Architects don’t preoccupy themselves with physics. Kind of the same answer. Yes, it’s true, and yet we outsource almost all of it (structural analysis). 
...
In the 20s, Corbusier was taking the machinery age in. But his answers were the pilotis and a couple of other executions.
...
So I start thinking why Pezo's office seems the place to be. 
...
Wait a minute. Let’s go slow here. 

How do I get to know this? 

I’ve read about them, and I’ve seen their projects. I’ve watched the institutions they relate with. But there is something else. 

The only way I see them doing their projects is by treating architecture as machinery, kind of making architecture a device to transmit the points of view and self-assessments of the very people behind them. 
...
I consider also that artists may be that shortcut to finding cool things and new takes into their practice. Maybe art is machinery for them? 
...
I start thinking about James P Carse, an author that touches the finite play, the struggle of doing something is here closely related to forcing a specific outcome, otherwise would be nothing to resist. 

What would James P. Carse have said to Pezo? Maybe he’s right. Dismiss machinery. Use it at a minimum. But we don’t know. 

Robert M. Prisig would say the contrary in any case. 

I bet Loos knew something about this also. 
...
computation as the ability to construct without needing other people, using levers to assemble an interactive product that can generate images and forms from a series of hows, rather than being just like physics concerned with the what and their simplifications. 
...
My contribution as a gamble between art, architecture, and computation, including philosophical questions that address the need for the machine and the way of being in a state of surprise, thus open to more possibilities in architecture. 

——

I rest a bit, and I start to remember that for Pezo, there are perfect machines, like the bull ring. A construction so ingrained as an archetypical yet useful object becomes a working building without much care for the building part nor the exact measures, but even then, is a pure transmission of cultural affairs that gets constructed in multiple ways and sizes. Plus, is circular, a shape that gets praise here and there, and, is a theater in some form for a defined audience, coming from the Spanish tradition. 
...
I see what the book on computational architecture has to say, so I pick the book named: the Codewritting Workbook by a Illinois professor. 

On the advantages of the computational approach: 
...
What I see, for now, it’s that is another tool for the craftsman, and yet the book is very hard to use in my experience. Due to the current state of the software, the commercial and arbitrary limitations of AutoCAD leave the core of auto lisp for a C-based compilation. Thus, making AutoLISP a mere fun thing. Not fundamentally necessary, not for the main player at least. But, as Paul Graham, an author that gives praise and detail to certain strengths of lisp, points out, there is something on lisp, that even when being a loser language (not very popular, not very practical), may be the hundred-year language. This may not be relevant to design in architecture, but longevity could still play in the cultural sense, that influences architecture in some, yet to determine ways. 

——-

I keep reading. 

If the Codewritting Workbook spans the idea of controlling design, even design choices. Carse, the author that revises finite and infinite games would point out that:
...
Machinery is a way to cut corners in a similar way, by allowing rationality to enter, thus diverting ourselves from the vitality we have within, and considering it as fuel for the very artifact at our disposal, that ends up shaping the way we do things. 

I cannot claim yet to be precise in this, but as we preoccupy with rationality, even if it’s for the creation of organic programs that includes part of the vitality, as in lisp, it’s always the fuel for a defined goal, thus serious and not playful, as stated. 

If architecture serves more than societal goals, the delta between cultural relations and societal aims is what interest us here. 

As with money, we are not concerned only with consumption and power plays, but with relationships between people, and their way to extend a tradition (doing things we cannot do by ourselves). 

But objects, as well as artifacts, including architectural 'objects' are valued and priced consequently. 

Today is especially easier to price artifacts that have some kind of high-end design embedded, thus, as Carse points out, obtaining some genius by giving away ours 
(One of the pitfalls of displaying a style). 
...
I can’t prove this, but they got into the heart of students and envious colleagues, by the use of rigor and admitting that the conversation just starts when there is rigor, thus the intention is showcased clearly and without bluff. 
...
Maybe that’s their core, that cannot be reduced further, that shows that some decisions are pointless, others pointless as art and gardening, and others at the level of social choice (the ones that generate reputation, because, why not right?). 
